...
const ChatComponent = ({ reportData }: Props) => {
  ...
  return (
    <div className="h-full bg-muted/50 relative flex flex-col min-h-[50vh] rounded-xl p-4 gap-4 lg:col-span-2">
        ...
        <Accordion type="single" className="text-sm" collapsible>
          <AccordionItem value="item-1">
            ...
            <AccordionContent className="whitespace-pre-wrap">
                <Markdown text={(data[data.length - 1] as any).context as string} />
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      )}
