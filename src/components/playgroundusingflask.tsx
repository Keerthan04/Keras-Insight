    ...
    <div className="grid h-screen w-full pl-[56px]">
      ...
      <div className="flex flex-col">
        <header className="sticky top-0 z-10 flex h-[57px] items-center gap-1 border-b bg-background px-4">
          ...
          <h1 className="text-xl font-semibold text-primary">KerasInsight</h1>
          <Drawer>
                ...
                <div className="grid gap-3">
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button disabled={analytics}>View Analytics</Button>
                    </DialogTrigger>
            ...
            <div className="flex-1">
              ...
              <div
                ...
                style={{
                  ...
                  overflowY: "scroll", // Allow scrolling if content exceeds container height
                  padding: "10px",
                  border: "1px solid #ccc",
                  borderRadius: "4px",
                  backgroundColor: "#f9f9f9",
                  maxHeight: "400px", // Set a maximum height for the output area,
                  minHeight: "100px",
                }}
              >
                {output}
